...
export const tesamorelin: Product = {
  ...
  name: "Tesamorelin",
  shortDescription:
    "Tesamorelin. Synthetic peptide for laboratory research. Laboratory-reported purity on third-party COA. Batch-specific Certificate of Analysis available. Not for human or animal use.",
  price: 89.99,
