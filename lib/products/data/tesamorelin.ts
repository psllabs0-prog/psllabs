...
export const tesamorelin: Product = {
  ...
  whyThisExists:
    "Tesamorelin is a synthetic peptide reference standard, sold as freeze dried powder for laboratory research. Lot purity comes from an independent lab purity test. See Batch Testing for published numbers.\n\nIt is a reference standard for analytical and in vitro lab work. Not for use in humans or animals.\n\nMatch your vial lot to the Certificate of Analysis in Batch Testing below.",
  bullets: [
