...
import { AdminAttributionDashboard } from "@/components/admin/admin-attribution-dashboard";
...
export const metadata: Metadata = createPageMetadata({
  ...
  description: "Paid acquisition attribution for completed orders.",
    ...
    return (
      <main className="min-h-screen bg-page px-6 py-12 md:px-16">
        <div className="mx-auto max-w-xl">
          ...
          <p className="mt-3 text-sm text-ash">
            Sign in to view paid acquisition attribution.
          </p>
          <div className="mt-8">
            <AdminLoginForm redirectTo="/admin-attribution" />
          </div>
        </div>
      </main>
    );
