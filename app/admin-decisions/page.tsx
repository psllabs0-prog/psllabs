...
import { AdminDecisionsDashboard } from "@/components/admin/admin-decisions-dashboard";
...
export const metadata: Metadata = createPageMetadata({
  ...
  description: "Cross-business decision engine for PSL Labs.",
    ...
    return (
      <main className="min-h-screen bg-page px-6 py-12 md:px-16">
        <div className="mx-auto max-w-xl">
          ...
          <p className="mt-3 text-sm text-ash">
            Sign in to review cross-business decisions.
          </p>
          <div className="mt-8">
            <AdminLoginForm redirectTo="/admin-decisions" />
          </div>
        </div>
      </main>
    );
